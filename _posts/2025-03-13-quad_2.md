...
Now that we’ve covered the theory, let’s take a look at how `JWT` is created and validated in practice by going through the code. I will introduce two Java classes: JwtAuthenticationFilter and `JwtProvider`.
